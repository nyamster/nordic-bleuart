...
$(OUTPUT_DIRECTORY)/nrf51422_xxac.out: \
  LINKER_SCRIPT  := ../ble_app_uart/pca10028/s130/armgcc/ble_app_uart_gcc_nrf51.ld
...
INC_FOLDERS += \
  ...
  ../ble_app_uart/pca10028/s130/config \
...
NEW_PATH := $(OUTPUT_DIRECTORY)/nrf51422_xxac.elf

# Default target - first one defined
default: nrf51422_xxac
	cp $(OUTPUT_DIRECTORY)/nrf51422_xxac.out $(NEW_PATH)
...
gdb:
	arm-none-eabi-gdb -x startup.gdb -q $(OUTPUT_DIRECTORY)/nrf51422_xxac.out -tui